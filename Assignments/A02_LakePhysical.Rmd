...
Tempprofiles1987 <- 
  ...
  labs(x = expression("Peter Lake Temperature in 1987"(degree*C)), y = "Depth (m)",color = "Ordinal Day") 
...
Tempprofiles2014 <- 
  ...
  scale_x_continuous(position = "top") +
  scale_color_viridis_c(end = 0.8, option = "magma") +
  labs(x = expression("Peter Lake Temperature in 2014"(degree*C)), y = "Depth (m)",color = "Ordinal Day") 
