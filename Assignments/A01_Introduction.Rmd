...
# Renaming columns 
names(EnoDischarge)[4:7]<-c("Discharge","Approval.Code","Gage_height","Approval.Code")
```
...
```{r}
library(lubridate)
new_column=EnoDischarge[,3]
Year=year(new_column)
EnoDischarge <- cbind(EnoDischarge,Year)
```
