...
Kan_Discharge.plot<-
  ...
  geom_line()+
  labs(x = "Solar Date Time", y = expression("Discharge(ft"^3*"/s"))
...
EcoHydRology::BaseflowSeparation(Kan.para$Discharge_m3s, 
  filter_parameter = 0.925, 
  passes = 3)

KANbaseflow <- BaseflowSeparation(
  Kan.para$Discharge_m3s, 
  filter_parameter = 0.925, 
  passes = 3
  )
