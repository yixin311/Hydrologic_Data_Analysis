...
Accessible and attractive and logical color patterns;
units;
axis labels;
legible font sizes;
...
<add notes here>
weather data: date, cloud thickness, rainfall, location
...
pal_futurama (function; comes in the ggsci package)ins
