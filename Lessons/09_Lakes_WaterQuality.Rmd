...
lagosne_get(dest_folder = LAGOSNE:::lagos_path(), overwrite = TRUE)# ONLY need to do once
...
# Order by number of lakes, keep all the rows, all the columns minus 1 means the common column
LAGOSlocations <- 
