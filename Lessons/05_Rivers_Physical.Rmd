...
1. discharge and flow = [V/t]; 
2. velocity = [distance/t]
3. bed material-> erosion -> turbidity
4. temperature
5. mixing -> turbulent + laminar flow
6. slope
## Session Set Up
...
# Join data frames
CombinedDischarge <- full_join(EnoDischarge, VerdeDischarge, by = "Date") %>% # join by date
...
> Eno 4, Verde, Bitterroot, Sauk, Nehalem: 3 
...
> "rbind" different site_no into one data frame, discharge by date,facet_grid by site_no. 
...
BitterrootDischarge.Historical <- mutate(BitterrootDischarge.Historical, 
                                         DOY = yday(Date)) # yday, transform date into ordinal day
...
climate, topography, location, precipitation effects 