...
>Quikflow: overland, pipe; Baseflow: groundwater,soil
...
>Nitrate is decreasing. Diluting: flow increases, nitrate concentration decreases.Chemostatic: No slope, concentration does not change with increase of flow; Flushing: concentration increases with the inrease of flow. Three states happen in different times of a flow. 
...
>counterclockwise: rising flow of a storm with concentration decreases and then with decrease of flow, the concentration rises.
...
>The amount of material in a stream is important 
...
>P~t: productivity: sunlight,+
>R~t: Respriation: all the time,-
>D~t: Dispersion, flow, +
