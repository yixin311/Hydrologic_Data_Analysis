...
1. what physical and chemical factors affect the number of SDWIS violation for dbps in active Alaska community water system

2. how are carbon concentration in Alaska streams changing over time?
<add more numbers as needed>

3. how  discharge affect the oc concentration?
...
1. 1a: H1: increased OC will increase the violation number
